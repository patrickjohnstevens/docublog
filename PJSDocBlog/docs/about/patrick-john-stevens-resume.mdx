...
Hello! I'm Patrick John Stevens. I'm a front-end developer with 6+ years of experience designing, engineering, managing and supporting websites and web applications. I enjoy creating websites and apps that are provide the user with a wonderful user experience and are truly valuable to them. I have an solid background building websites and apps with WordPress and modern front-end frameworks/tooling. I am an empathetic and effictive communicator with coworkers, stakeholders, vendors, and clients. I am a self-starter and a quick learner. I am a problem solver and a creative thinker. I am a team player and a leader. I am a lifelong learner.

## <u>SKILLS</u>

### Web Development

- Proficient coding with modern HTML5, CSS3, and JavaScript; Classic and Block WordPress Themes and Plugins, WP-Engine/Flywheel/Siteground Hosting, WordPress and PHP Coding Standards, MySQL, REST, Ionic Framework, Capacitor, Angular, GitHub, BitBucket, Bash/Shell, VSCode

- Experienced with React, TypeScript, jQuery, JS testing (Jest, Cypress, and PlayWrite), git/GitHub, NPM, CLIs, DNS, Docusourous, Vercel

- Exploritory React/Remix/Next, Vue/Nuxt, Astro, QwikCity, Svelte/SvelteKit, SolidStart, TypeScript, Tailwind CSS, Headless CMS WordPress/Drupal, GraphQL, JAM Stack, Vercel, Netlify, Deno, Supabase, Xata
...
## <u>STRENGTHS</u> | 02-24-2020

### Leadership Style

You primarily lead through your strengths of stategic thinking and relationship building. If you sense a leadership gap, you naturally step up and lead using your influencing strengths.

### Top 10 Strengths

1. **Strategic** - You quickly weigh alternative paths and determine the best one. Your natural ability to anticipate, play out different scenarios and plan ahead makes you an agile decision-maker.
...
Assit multiple companies with website design and development, SEO, WordPress Hosting, business consulting, and marketing strategy 0n part-time basis. All our customers have sites built on WordPress.
...
VoterSnap was a mobile site that generated the full version of a voter’s ballot and candidates presented to the voter on Election Day. However, instead of just seeing a name and a party reference, it provided powerful and concise message directly from the candidates.
...
- [CodePen](http://codepen.io/patrickjohnstevens)

### Projects

- [Personal Knowledge Hub / Open Source Knowledge Hub](https://hub.patrickjohnstevens.com/)

- [Get Wisdom Every Day / Christian Wisdom - Personal Blog](https://hub.patrickjohnstevens.com/)

- [PS WebWork LLC / Business Website](https://hub.patrickjohnstevens.com/)

## <u>Voluteering</u>

### [WordCamp Omaha](https://omaha.wordcamp.org/2018/speaker/patrick-stevens/)

_2018 - TBD_ | **Speaker, Teacher, Coding Volunteer**

I'm volunteer to help people interested in using Wordpress to achieve their goals and to improve my skills as a web designer & developer, teacher, and speaker. I'm hoping WordCamp Omaha will start back up in 2023.
