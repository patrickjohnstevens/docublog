---
title: Change The Font-Family in Docusaurus
description: Learn how to change the font-family in Docusaurus.
authors:
...
4. Add Head tags to preload the fonts (Learned from the Docusaurus 2 docs and Google searching)
5. Test the site and make sure the fonts are working (Used the Chrome Dev Tools to check the fonts or download the CSS Peeper browser extension)
