---
title: Made 100% Using github.dev
...
# Testing github.dev on my phone. I was curious if I could  create a new file, commit and push it to my docublog repository, which  I think Vercel will auto build the changes. 
