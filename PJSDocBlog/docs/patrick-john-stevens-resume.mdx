...
- Exploratory React/Remix/Next, Vue/Nuxt, Astro, QwikCity, Svelte/SvelteKit, SolidStart, TypeScript, Tailwind CSS, Headless CMS WordPress/Drupal, GraphQL, JAM Stack, Vercel, Netlify, Deno, Supabase, Xata
